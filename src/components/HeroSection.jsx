...
export default function HeroSection({ title, subtitle }) {
  return (
    <div className="text-center pt-10 pb-6 px-4">
      ...
      <h1 className="font-cinzel font-bold text-3xl md:text-5xl text-yellow-300 drop-shadow-lg mb-3" style={{ textShadow: "0 2px 12px rgba(200,150,0,0.5)" }}>
        {title}
      </h1>
      {subtitle && (
        <p className="font-lora italic text-yellow-100/90 text-lg md:text-xl max-w-2xl mx-auto">
          {subtitle}
        </p>
      )}
    </div>
